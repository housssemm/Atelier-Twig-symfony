...
class AuthorController extends AbstractController
{
    ...
    #[Route('/aff', name: 'recherche')]
    public function rech(AuthorRepository $repoAuthor, Request $req): Response
    {
        $min = $req->get('min');
        $max = $req->get('max');
        $list = $repoAuthor->minMax($min, $max);
        return $this->render('author/read.html.twig', ['authors' => $list]);
    }

    #[Route('/affByEmail', name: 'affByEmail')]
    public function affEmail(AuthorRepository $repoAuthor): Response
    {
        
        $list = $repoAuthor->findByEmail();
        return $this->render('author/read.html.twig', ['authors' => $list]);
    }
